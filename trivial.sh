...
sleep 2
echo "Si aciertas todos las preguntas, te concedere el titulo de magister del universo."
...
a Alejandro Magno, plat{on, aristoteles o zenon?"
read respuesta2
if test $respuesta2 = aristoteles
echo "respusta correcta."
else
